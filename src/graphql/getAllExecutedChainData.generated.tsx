...
export type GetExecutedSourceChainsQueryVariables = Types.Exact<{
  where?: Types.InputMaybe<Types.ExecutedSourceChain_Filter>;
}>;


export type GetExecutedSourceChainsQuery = { __typename?: 'Query', executedSourceChains: Array<{ __typename?: 'ExecutedSourceChain', _amountOut: any, _from: any, _fundsUsed: any, _jobId: any, _timesExecuted: any, blockNumber: any, blockTimestamp: any, id: string, transactionHash: any }> };


export const GetExecutedSourceChainsDocument = gql`
    query getExecutedSourceChains($where: ExecutedSourceChain_filter) {
  executedSourceChains(where: $where) {
    _amountOut
    _from
    _fundsUsed
    _jobId
...
/**
 * __useGetExecutedSourceChainsQuery__
 *
 * To run a query within a React component, call `useGetExecutedSourceChainsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetExecutedSourceChainsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetExecutedSourceChainsQuery({
 *   variables: {
 *      where: // value for 'where'
 *   },
 * });
 */
export function useGetExecutedSourceChainsQuery(baseOptions?: Apollo.QueryHookOptions<GetExecutedSourceChainsQuery, GetExecutedSourceChainsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetExecutedSourceChainsQuery, GetExecutedSourceChainsQueryVariables>(GetExecutedSourceChainsDocument, options);
      }
export function useGetExecutedSourceChainsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetExecutedSourceChainsQuery, GetExecutedSourceChainsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetExecutedSourceChainsQuery, GetExecutedSourceChainsQueryVariables>(GetExecutedSourceChainsDocument, options);
        }
export type GetExecutedSourceChainsQueryHookResult = ReturnType<typeof useGetExecutedSourceChainsQuery>;
export type GetExecutedSourceChainsLazyQueryHookResult = ReturnType<typeof useGetExecutedSourceChainsLazyQuery>;
export type GetExecutedSourceChainsQueryResult = Apollo.QueryResult<GetExecutedSourceChainsQuery, GetExecutedSourceChainsQueryVariables>;