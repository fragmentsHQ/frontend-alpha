...
export type GetAJobQueryVariables = Types.Exact<{
  block?: Types.InputMaybe<Types.Block_Height>;
  id: Types.Scalars['ID']['input'];
  subgraphError?: Types.InputMaybe<Types._SubgraphErrorPolicy_>;
}>;

export type GetAJobQuery = {
  __typename?: 'Query';
  jobCreated?: {
    __typename?: 'JobCreated';
    _to: any;
 ...
 * });
 */
export function useGetAJobQuery(
  baseOptions: Apollo.QueryHookOptions<GetAJobQuery, GetAJobQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAJobQuery, GetAJobQueryVariables>(
    GetAJobDocument,
    options
  );
}
export function useGetAJobLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetAJobQuery, GetAJobQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetAJobQuery, GetAJobQueryVariables>(
    GetAJobDocument,
    options
  );
}
...
export type GetAJobQueryResult = Apollo.QueryResult<
  GetAJobQuery,
  GetAJobQueryVariables
>;
