...
export type GetFundsWithdrawnsQueryVariables = Types.Exact<{
  orderBy?: Types.InputMaybe<Types.FundsWithdrawn_OrderBy>;
  orderDirection?: Types.InputMaybe<Types.OrderDirection>;
  where?: Types.InputMaybe<Types.FundsWithdrawn_Filter>;
}>;


export type GetFundsWithdrawnsQuery = { __typename?: 'Query', fundsWithdrawns: Array<{ __typename?: 'FundsWithdrawn', amount: any, blockNumber: any, blockTimestamp: any, id: string, token: any, transactionHash: any }> };


export const GetFundsWithdrawnsDocument = gql`
    query getFundsWithdrawns($orderBy: FundsWithdrawn_orderBy, $orderDirection: OrderDirection, $where: FundsWithdrawn_filter) {
  fundsWithdrawns(
    orderBy: $orderBy
...
/**
 * __useGetFundsWithdrawnsQuery__
 *
 * To run a query within a React component, call `useGetFundsWithdrawnsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetFundsWithdrawnsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetFundsWithdrawnsQuery({
 *   variables: {
 ...
 * });
 */
export function useGetFundsWithdrawnsQuery(baseOptions?: Apollo.QueryHookOptions<GetFundsWithdrawnsQuery, GetFundsWithdrawnsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFundsWithdrawnsQuery, GetFundsWithdrawnsQueryVariables>(GetFundsWithdrawnsDocument, options);
      }
export function useGetFundsWithdrawnsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFundsWithdrawnsQuery, GetFundsWithdrawnsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFundsWithdrawnsQuery, GetFundsWithdrawnsQueryVariables>(GetFundsWithdrawnsDocument, options);
        }
export type GetFundsWithdrawnsQueryHookResult = ReturnType<typeof useGetFundsWithdrawnsQuery>;
export type GetFundsWithdrawnsLazyQueryHookResult = ReturnType<typeof useGetFundsWithdrawnsLazyQuery>;
export type GetFundsWithdrawnsQueryResult = Apollo.QueryResult<GetFundsWithdrawnsQuery, GetFundsWithdrawnsQueryVariables>;